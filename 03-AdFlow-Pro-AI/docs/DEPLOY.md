...
**[https://vercel.com/muhammad-arslans-projects-6abbf6f8](https://vercel.com/muhammad-arslans-projects-6abbf6f8)**
...
2. **Open your Vercel space**  
   Go to: [vercel.com/muhammad-arslans-projects-6abbf6f8](https://vercel.com/muhammad-arslans-projects-6abbf6f8)

3. **Add a project**  
   Click **Add New…** → **Project** → **Import** your GitHub repository.

4. **Monorepo: set root directory**  
   If the repo root is `Muhammad-Arslan-fa23bcs-030-A--web` (parent folder), set:
...
When linking, pick the **scope** that matches **Muhammad Arslan’s projects** / your team so the project appears under [that dashboard](https://vercel.com/muhammad-arslans-projects-6abbf6f8).
...
| GitHub repo = **whole** `Muhammad-Arslan-fa23bcs-030-A--web` | Root Directory = **`03-AdFlow-Pro-AI`** |
